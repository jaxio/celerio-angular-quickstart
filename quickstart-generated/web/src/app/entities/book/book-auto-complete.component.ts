...
export const BOOK_AUTO_COMPLETE_CONTROL_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => BookCompleteComponent),
    multi: true
};
...
@Component({
    ...
    providers: [BOOK_AUTO_COMPLETE_CONTROL_VALUE_ACCESSOR]
})
export class BookCompleteComponent implements ControlValueAccessor {
