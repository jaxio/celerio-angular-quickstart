...
export class UserService {
    ...
    update(user : User) : Observable<User> {
        ...
        return this.http.put(environment.url+'/api/users/', body, this.options)
            .map(response => new User(response.json()))
            .catch(this.handleError);
    }
    ...
    getPage(user : User, event : LazyLoadEvent) : Observable<PageResponse<User>> {
        ...
        return this.http.post(environment.url+'/api/users/page', body, this.options)
            .map(response => {
    ...
    complete(query : string) : Observable<User[]> {
        ...
        return this.http.post(environment.url+'/api/users/complete', body, this.options)
     ...
     */
    delete(id : any) {
        return this.http.delete(environment.url+'/api/users/' + id).catch(this.handleError);
    }
