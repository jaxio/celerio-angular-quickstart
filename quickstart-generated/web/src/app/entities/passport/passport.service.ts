...
export class PassportService {
    ...
    getPassport(id : any) : Observable<Passport> {
        return this.http.get(environment.url+'/api/passports/' + id)
    ...
    update(passport : Passport) : Observable<Passport> {
        ...
        return this.http.put(environment.url+'/api/passports/', body, this.options)
            .map(response => new Passport(response.json()))
            .catch(this.handleError);
    }
    ...
    getPage(passport : Passport, event : LazyLoadEvent) : Observable<PageResponse<Passport>> {
        ...
        return this.http.post(environment.url+'/api/passports/page', body, this.options)
            .map(response => {
    ...
    complete(query : string) : Observable<Passport[]> {
        ...
        return this.http.post(environment.url+'/api/passports/complete', body, this.options)
     ...
     */
    delete(id : any) {
        return this.http.delete(environment.url+'/api/passports/' + id).catch(this.handleError);
    }
