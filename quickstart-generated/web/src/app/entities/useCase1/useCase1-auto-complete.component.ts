...
export const USECASE1_AUTO_COMPLETE_CONTROL_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => UseCase1CompleteComponent),
    multi: true
};
...
@Component({
    ...
    providers: [USECASE1_AUTO_COMPLETE_CONTROL_VALUE_ACCESSOR]
})
export class UseCase1CompleteComponent implements ControlValueAccessor {
    ...
    constructor(private useCase1Service : UseCase1Service, private messageService : MessageService) {
    }
