...
export class UseCase1Service {
    ...
    getUseCase1(id : any) : Observable<UseCase1> {
        return this.http.get(environment.url+'/api/useCase1s/' + id)
    ...
    update(useCase1 : UseCase1) : Observable<UseCase1> {
        ...
        return this.http.put(environment.url+'/api/useCase1s/', body, this.options)
            .map(response => new UseCase1(response.json()))
            .catch(this.handleError);
    }
    ...
    getPage(useCase1 : UseCase1, event : LazyLoadEvent) : Observable<PageResponse<UseCase1>> {
        ...
        return this.http.post(environment.url+'/api/useCase1s/page', body, this.options)
            .map(response => {
    ...
    complete(query : string) : Observable<UseCase1[]> {
        ...
        return this.http.post(environment.url+'/api/useCase1s/complete', body, this.options)
     ...
     */
    delete(id : any) {
        return this.http.delete(environment.url+'/api/useCase1s/' + id).catch(this.handleError);
    }
