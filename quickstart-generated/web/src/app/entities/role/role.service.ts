...
export class RoleService {
    ...
    update(role : Role) : Observable<Role> {
        ...
        return this.http.put(environment.url+'/api/roles/', body, this.options)
            .map(response => new Role(response.json()))
            .catch(this.handleError);
    }
    ...
    getPage(role : Role, event : LazyLoadEvent) : Observable<PageResponse<Role>> {
        ...
        return this.http.post(environment.url+'/api/roles/page', body, this.options)
            .map(response => {
    ...
    complete(query : string) : Observable<Role[]> {
        ...
        return this.http.post(environment.url+'/api/roles/complete', body, this.options)
     ...
     */
    delete(id : any) {
        return this.http.delete(environment.url+'/api/roles/' + id).catch(this.handleError);
    }
