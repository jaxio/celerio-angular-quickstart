...
export class DeviceService {
    ...
    getDevice(id : any) : Observable<Device> {
        return this.http.get(environment.url+'/api/devices/' + id)
    ...
    update(device : Device) : Observable<Device> {
        ...
        return this.http.put(environment.url+'/api/devices/', body, this.options)
            .map(response => new Device(response.json()))
            .catch(this.handleError);
    }
    ...
    getPage(device : Device, event : LazyLoadEvent) : Observable<PageResponse<Device>> {
        ...
        return this.http.post(environment.url+'/api/devices/page', body, this.options)
            .map(response => {
    ...
    complete(query : string) : Observable<Device[]> {
        ...
        return this.http.post(environment.url+'/api/devices/complete', body, this.options)
     ...
     */
    delete(id : any) {
        return this.http.delete(environment.url+'/api/devices/' + id).catch(this.handleError);
    }
