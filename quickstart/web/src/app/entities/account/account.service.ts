...
export class AccountService {
    ...
    update(account : Account) : Observable<Account> {
        ...
        return this.http.put('/api/accounts/', body, this.options)
            .map(response => new Account(response.json()))
            .catch(this.handleError);
    }
    ...
    getPage(account : Account, event : LazyLoadEvent) : Observable<PageResponse<Account>> {
        ...
        return this.http.post('/api/accounts/page', body, this.options)
            .map(response => {
    ...
    complete(query : string) : Observable<Account[]> {
        ...
        return this.http.post('/api/accounts/complete', body, this.options)
     ...
     */
    delete(id : any) {
        return this.http.delete('/api/accounts/' + id).catch(this.handleError);
    }
