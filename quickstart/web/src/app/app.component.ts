    ...
    ngOnInit() {
        this.items = [
            ...
            { label: 'Entities', icon: 'fa-search', items: [
                    {label: 'Account Search', routerLink: ['/account-list']},
                    {label: 'Account Create', routerLink: ['/account/new']},
                    {label: 'AlarmReading Search', routerLink: ['/alarmReading-list']},
                    {label: 'AlarmReading Create', routerLink: ['/alarmReading/new']},
                    {label: 'AlarmRule Search', routerLink: ['/alarmRule-list']},
                    {label: 'AlarmRule Create', routerLink: ['/alarmRule/new']},
                    {label: 'Device Search', routerLink: ['/device-list']},
                    {label: 'Device Create', routerLink: ['/device/new']},
                    {label: 'TempReading Search', routerLink: ['/tempReading-list']},
                    {label: 'TempReading Create', routerLink: ['/tempReading/new']}                ]
            },
