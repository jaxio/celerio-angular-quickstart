*Prerequisites:* [Java Development Kit 8](http://www.oracle.com/technetwork/java/javase/downloads/index.html) + [Maven 3.3.3](https://maven.apache.org/download.cgi) + [Npm 3.x.x](https://nodejs.org/en/)
