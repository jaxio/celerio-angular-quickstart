...
The 3 command below install some additional dependencies required by the code generated by Celerio. 

    npm install --save primeng
    npm install --save @angular/material
    npm install --save font-awesome        

Starts a node server on port 4200 using angular cli. The node server proxies the calls to /apo and /img to the 
spring boot backend.
